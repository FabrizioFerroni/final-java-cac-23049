...
<html>
    <head>
        ...
        <title>Tickets - Trabajo Integrador Final CAC 23049 - Fabrizio Ferroni</title>
    ...
    <div class="container d-flex justify-content-center align-items-center flex-column mt-5 mb-5">
        <h3 class="text-capitalize text-muted text-center">todos los tickets que fueron comprados</h3>
        <%
            /*codigo java*/
        ...
        <table id="example" class="dataTable text-center table table-striped display" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-capitalize"><%= ticket.getNombre()%></td>
                ...
                buttons: {
                    ...
                    buttons: [{
                            ...
                            buttons: [{
                                    ...
                                    title: 'Tickets CaC 23049 Fabrizio Ferroni',
                                    exportOptions: {
                                ...
                                },
                                {
                                    ...
                                    title: 'Listado de tickets comprados',
                                    sheetName: 'Tickets CaC 23049 Fabrizio Ferroni',
                                    header: true,
                                    footer: false,
                                    excelStyles: [
                                        {
                                            ...
                                            return {
                                                columns: [
                                                    ...
                                                    },
                                                    {
                                                        alignment: 'left',
                                                        italics: true,
                                                        text: 'Listado de tickets comprados',
                                                        fontSize: 18,
                                                        margin: [5, 5]
                                                    },
                                                    {
