...
<html>
    <head>
        ...
        <title>Iniciar sesion - Trabajo Integrador Final CAC 23049 - Fabrizio Ferroni</title>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="card-login p-5 border-1">
            ...
            <div class="d-flex justify-content-center flex-column align-items-center pb-3 ">
                ...
                <span class="fs-1 text-muted">Iniciar sesión</span>
            </div>
            ...
            <div class="container">
                ...
                <form class="needs-validation mb-2" method="post" action="iniciarsesion"> <%--convertite__info--form--%>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="username" placeholder="Username" autocomplete="off" value="<%= request.getAttribute("username") != null ? request.getAttribute("username") : ""%>">
                        <label for="floatingInput">Nombre de usuario</label>
                    </div>
                    <div class="form-floating">
                        <input type="password" class="form-control" name="password" id="floatingPassword" placeholder="Contraseña" autocomplete="off">
                        <label for="floatingPassword">Contraseña</label>
                    </div>
                    <div class="d-block mt-3">
                        <button class="btn btn-success btn-lg w-100" type="submit">Iniciar sesion</button>
                    </div>
                </form>
                <span class="text-muted">No tenes cuenta? Haz <a href="/registrarse" class="text-decoration-none">click aquí</a> para registrarte</span>
            </div>
        </div>
    </div>
